  ...
  public class Verifier
  {
    ...
    private short GetVRelOffset(int pos, short vtableOffset)
    {
      ...
      try
      {
        ...
        // FragmentsUnity fix: the vtable position is an absolute buffer offset and must not be
        // narrowed to Int16; upstream's Convert.ToInt16 overflows for any vtable past byte 32767.
      ...
      {
        // FragmentsUnity fix: no console output from library code; a failed read verifies as absent.
        return VOffset;
      }
      return VOffset;
