...
public struct ShellHole : IFlatbufferObject
{
  ...
  public static Offset<FragmentsUnity.Schema.ShellHole> CreateShellHole(FlatBufferBuilder builder,
  ...
  public static Offset<FragmentsUnity.Schema.ShellHole> EndShellHole(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // indices
    return new Offset<FragmentsUnity.Schema.ShellHole>(o);
  }
}
