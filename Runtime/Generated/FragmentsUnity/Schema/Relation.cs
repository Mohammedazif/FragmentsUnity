...
public struct Relation : IFlatbufferObject
{
  ...
  public static Offset<FragmentsUnity.Schema.Relation> CreateRelation(FlatBufferBuilder builder,
  ...
  public static Offset<FragmentsUnity.Schema.Relation> EndRelation(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<FragmentsUnity.Schema.Relation>(o);
  }
}
