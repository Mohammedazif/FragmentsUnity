...
public struct ShellProfile : IFlatbufferObject
{
  ...
  public static Offset<FragmentsUnity.Schema.ShellProfile> CreateShellProfile(FlatBufferBuilder builder,
  ...
  public static Offset<FragmentsUnity.Schema.ShellProfile> EndShellProfile(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // indices
    return new Offset<FragmentsUnity.Schema.ShellProfile>(o);
  }
}
