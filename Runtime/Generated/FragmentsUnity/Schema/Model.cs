...
public struct Model : IFlatbufferObject
{
  ...
  public FragmentsUnity.Schema.Meshes? Meshes { get { int o = __p.__offset(16); return o != 0 ? (FragmentsUnity.Schema.Meshes?)(new FragmentsUnity.Schema.Meshes()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  public FragmentsUnity.Schema.Attribute? Attributes(int j) { int o = __p.__offset(18); return o != 0 ? (FragmentsUnity.Schema.Attribute?)(new FragmentsUnity.Schema.Attribute()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int AttributesLength { get { int o = __p.__offset(18); return o != 0 ? __p.__vector_len(o) : 0; } }
  public FragmentsUnity.Schema.Relation? Relations(int j) { int o = __p.__offset(20); return o != 0 ? (FragmentsUnity.Schema.Relation?)(new FragmentsUnity.Schema.Relation()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public FragmentsUnity.Schema.SpatialStructure? SpatialStructure { get { int o = __p.__offset(26); return o != 0 ? (FragmentsUnity.Schema.SpatialStructure?)(new FragmentsUnity.Schema.SpatialStructure()).__assign(__p.__indirect(o + __p.bb_pos), __p.bb) : null; } }
  ...
  public FragmentsUnity.Schema.ModelIndex? Indexes(int j) { int o = __p.__offset(32); return o != 0 ? (FragmentsUnity.Schema.ModelIndex?)(new FragmentsUnity.Schema.ModelIndex()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int IndexesLength { get { int o = __p.__offset(32); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FragmentsUnity.Schema.Model> CreateModel(FlatBufferBuilder builder,
      ...
      Offset<FragmentsUnity.Schema.Meshes> meshesOffset = default(Offset<FragmentsUnity.Schema.Meshes>),
      ...
      Offset<FragmentsUnity.Schema.SpatialStructure> spatial_structureOffset = default(Offset<FragmentsUnity.Schema.SpatialStructure>),
  ...
  public static void AddMeshes(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Meshes> meshesOffset) { builder.AddOffset(6, meshesOffset.Value, 0); }
  ...
  public static VectorOffset CreateAttributesVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Attribute>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Attribute>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.Attribute>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAttributesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.Attribute>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRelationsVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Relation>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Relation>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.Relation>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateRelationsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.Relation>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static void AddSpatialStructure(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.SpatialStructure> spatialStructureOffset) { builder.AddOffset(11, spatialStructureOffset.Value, 0); }
  ...
  public static VectorOffset CreateIndexesVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.ModelIndex>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.ModelIndex>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.ModelIndex>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateIndexesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.ModelIndex>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartIndexesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<FragmentsUnity.Schema.Model> EndModel(FlatBufferBuilder builder) {
    ...
    return new Offset<FragmentsUnity.Schema.Model>(o);
  }
  public static void FinishModelBuffer(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Model> offset) { builder.Finish(offset.Value, "0001"); }
  public static void FinishSizePrefixedModelBuffer(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Model> offset) { builder.FinishSizePrefixed(offset.Value, "0001"); }
}
...
static public class ModelVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyTable(tablePos, 16 /*Meshes*/, FragmentsUnity.Schema.MeshesVerify.Verify, true)
      && verifier.VerifyVectorOfTables(tablePos, 18 /*Attributes*/, FragmentsUnity.Schema.AttributeVerify.Verify, false)
      && verifier.VerifyVectorOfTables(tablePos, 20 /*Relations*/, FragmentsUnity.Schema.RelationVerify.Verify, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*RelationsItems*/, 4 /*int*/, false)
      && verifier.VerifyString(tablePos, 24 /*Guid*/, true)
      && verifier.VerifyTable(tablePos, 26 /*SpatialStructure*/, FragmentsUnity.Schema.SpatialStructureVerify.Verify, false)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 32 /*Indexes*/, FragmentsUnity.Schema.ModelIndexVerify.Verify, false)
