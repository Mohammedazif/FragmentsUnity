...
public struct CircleExtrusion : IFlatbufferObject
{
  ...
  public FragmentsUnity.Schema.Axis? Axes(int j) { int o = __p.__offset(6); return o != 0 ? (FragmentsUnity.Schema.Axis?)(new FragmentsUnity.Schema.Axis()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int AxesLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FragmentsUnity.Schema.CircleExtrusion> CreateCircleExtrusion(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateAxesVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Axis>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAxesVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.Axis>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAxesVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.Axis>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAxesVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.Axis>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartAxesVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<FragmentsUnity.Schema.CircleExtrusion> EndCircleExtrusion(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // radius
    builder.Required(o, 6);  // axes
    return new Offset<FragmentsUnity.Schema.CircleExtrusion>(o);
  }
}
...
static public class CircleExtrusionVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 6 /*Axes*/, FragmentsUnity.Schema.AxisVerify.Verify, true)
