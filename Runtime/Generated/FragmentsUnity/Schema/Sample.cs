...
public struct Sample : IFlatbufferObject
{
  ...
  public static Offset<FragmentsUnity.Schema.Sample> CreateSample(FlatBufferBuilder builder, uint Item, uint Material, uint Representation, uint LocalTransform) {
    builder.Prep(4, 16);
    builder.PutUint(LocalTransform);
    builder.PutUint(Representation);
    builder.PutUint(Material);
    builder.PutUint(Item);
    return new Offset<FragmentsUnity.Schema.Sample>(builder.Offset);
  }
}
