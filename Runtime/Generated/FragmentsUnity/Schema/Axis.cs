...
public struct Axis : IFlatbufferObject
{
  ...
  public FragmentsUnity.Schema.Wire? Wires(int j) { int o = __p.__offset(4); return o != 0 ? (FragmentsUnity.Schema.Wire?)(new FragmentsUnity.Schema.Wire()).__assign(__p.__vector(o) + j * 24, __p.bb) : null; }
  ...
  public FragmentsUnity.Schema.AxisPartClass Parts(int j) { int o = __p.__offset(8); return o != 0 ? (FragmentsUnity.Schema.AxisPartClass)__p.bb.GetSbyte(__p.__vector(o) + j * 1) : (FragmentsUnity.Schema.AxisPartClass)0; }
  public int PartsLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<FragmentsUnity.Schema.AxisPartClass> GetPartsBytes() { return __p.__vector_as_span<FragmentsUnity.Schema.AxisPartClass>(8, 1); }
#else
  public ArraySegment<byte>? GetPartsBytes() { return __p.__vector_as_arraysegment(8); }
#endif
  public FragmentsUnity.Schema.AxisPartClass[] GetPartsArray() { int o = __p.__offset(8); if (o == 0) return null; int p = __p.__vector(o); int l = __p.__vector_len(o); FragmentsUnity.Schema.AxisPartClass[] a = new FragmentsUnity.Schema.AxisPartClass[l]; for (int i = 0; i < l; i++) { a[i] = (FragmentsUnity.Schema.AxisPartClass)__p.bb.GetSbyte(p + i * 1); } return a; }
  public FragmentsUnity.Schema.WireSet? WireSets(int j) { int o = __p.__offset(10); return o != 0 ? (FragmentsUnity.Schema.WireSet?)(new FragmentsUnity.Schema.WireSet()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int WireSetsLength { get { int o = __p.__offset(10); return o != 0 ? __p.__vector_len(o) : 0; } }
  public FragmentsUnity.Schema.CircleCurve? CircleCurves(int j) { int o = __p.__offset(12); return o != 0 ? (FragmentsUnity.Schema.CircleCurve?)(new FragmentsUnity.Schema.CircleCurve()).__assign(__p.__vector(o) + j * 44, __p.bb) : null; }
  public int CircleCurvesLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FragmentsUnity.Schema.Axis> CreateAxis(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreatePartsVector(FlatBufferBuilder builder, FragmentsUnity.Schema.AxisPartClass[] data) { builder.StartVector(1, data.Length, 1); for (int i = data.Length - 1; i >= 0; i--) builder.AddSbyte((sbyte)data[i]); return builder.EndVector(); }
  public static VectorOffset CreatePartsVectorBlock(FlatBufferBuilder builder, FragmentsUnity.Schema.AxisPartClass[] data) { builder.StartVector(1, data.Length, 1); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePartsVectorBlock(FlatBufferBuilder builder, ArraySegment<FragmentsUnity.Schema.AxisPartClass> data) { builder.StartVector(1, data.Count, 1); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreatePartsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<FragmentsUnity.Schema.AxisPartClass>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static VectorOffset CreateWireSetsVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.WireSet>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateWireSetsVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.WireSet>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWireSetsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.WireSet>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateWireSetsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.WireSet>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  ...
  public static Offset<FragmentsUnity.Schema.Axis> EndAxis(FlatBufferBuilder builder) {
    ...
    return new Offset<FragmentsUnity.Schema.Axis>(o);
  }
}
...
static public class AxisVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfData(tablePos, 4 /*Wires*/, 24 /*FragmentsUnity.Schema.Wire*/, true)
      && verifier.VerifyVectorOfData(tablePos, 6 /*Order*/, 4 /*uint*/, true)
      && verifier.VerifyVectorOfData(tablePos, 8 /*Parts*/, 1 /*FragmentsUnity.Schema.AxisPartClass*/, true)
      && verifier.VerifyVectorOfTables(tablePos, 10 /*WireSets*/, FragmentsUnity.Schema.WireSetVerify.Verify, true)
      && verifier.VerifyVectorOfData(tablePos, 12 /*CircleCurves*/, 44 /*FragmentsUnity.Schema.CircleCurve*/, true)
