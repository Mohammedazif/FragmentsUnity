...
public struct Attribute : IFlatbufferObject
{
  ...
  public static Offset<FragmentsUnity.Schema.Attribute> CreateAttribute(FlatBufferBuilder builder,
  ...
  public static Offset<FragmentsUnity.Schema.Attribute> EndAttribute(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    builder.Required(o, 4);  // data
    return new Offset<FragmentsUnity.Schema.Attribute>(o);
  }
}
