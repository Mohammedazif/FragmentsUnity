...
public struct SpatialStructure : IFlatbufferObject
{
  ...
  public FragmentsUnity.Schema.SpatialStructure? Children(int j) { int o = __p.__offset(8); return o != 0 ? (FragmentsUnity.Schema.SpatialStructure?)(new FragmentsUnity.Schema.SpatialStructure()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int ChildrenLength { get { int o = __p.__offset(8); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FragmentsUnity.Schema.SpatialStructure> CreateSpatialStructure(FlatBufferBuilder builder,
      uint? local_id = null,
  ...
  public static VectorOffset CreateChildrenVector(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.SpatialStructure>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateChildrenVectorBlock(FlatBufferBuilder builder, Offset<FragmentsUnity.Schema.SpatialStructure>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChildrenVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<FragmentsUnity.Schema.SpatialStructure>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateChildrenVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<FragmentsUnity.Schema.SpatialStructure>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartChildrenVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<FragmentsUnity.Schema.SpatialStructure> EndSpatialStructure(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FragmentsUnity.Schema.SpatialStructure>(o);
  }
}
...
static public class SpatialStructureVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 8 /*Children*/, FragmentsUnity.Schema.SpatialStructureVerify.Verify, false)
