...
public struct WireSet : IFlatbufferObject
{
  ...
  public FragmentsUnity.Schema.FloatVector? Ps(int j) { int o = __p.__offset(4); return o != 0 ? (FragmentsUnity.Schema.FloatVector?)(new FragmentsUnity.Schema.FloatVector()).__assign(__p.__vector(o) + j * 12, __p.bb) : null; }
  public int PsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<FragmentsUnity.Schema.WireSet> CreateWireSet(FlatBufferBuilder builder,
  ...
  public static Offset<FragmentsUnity.Schema.WireSet> EndWireSet(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FragmentsUnity.Schema.WireSet>(o);
  }
}
...
static public class WireSetVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyVectorOfData(tablePos, 4 /*Ps*/, 12 /*FragmentsUnity.Schema.FloatVector*/, false)
